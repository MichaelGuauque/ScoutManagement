...
public class EmailService {
    ...
    public String generarTemplatePassword(String password, String nombreUsuario) {
        return """
    <!DOCTYPE html>
               <html lang="es">
               <head>
                   ...
                   <tr>
                     <td style="padding: 20px 0;">
                       <table align="center" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" class="email-container">
                         ...
                         <tr>
                           <td class="header">
                             <h1>Bienvenido a Scout Management</h1>
                           </td>
                         </tr>
                         ...
                         <tr>
                           <td class="content">
                             ...
                             <p style="color: #333333 !important;">¡Te damos la bienvenida! Se ha creado una cuenta para ti en nuestro sistema. Para acceder por primera vez, utiliza la siguiente contraseña temporal:</p>
                             ...
                             <p style="color: #333333 !important;">Para iniciar sesión en tu cuenta, por favor sigue estos pasos:</p>
                             ...
                             <div class="button-container">
                               <a href="#" class="reset-button">Ingresa Aqui</a>
                             </div>
    ...
    """.formatted(nombreUsuario, password);
    }
